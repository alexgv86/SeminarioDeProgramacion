...
Type
  oMatriz = Object
    ...
    Public
      ...
      Function DiagonalPrincipal(): oVector;
      Function DiagonalOpuesta(): oVector;
      Function MaximaFila(): oVector;
      Function MaximaColumna(): oVector;
...
Function oMatriz.DiagonalPrincipal(): oVector;
Begin
...
// El vector es el definido en el punto 1
Function oMatriz.DiagonalOpuesta(): oVector;
Begin
...
// El vector es el definido en el punto 1
Function oMatriz.MaximaFila(): oVector;
Begin
...
// El vector es el definido en el punto 1
Function oMatriz.MaximaColumna(): oVector;
Begin
